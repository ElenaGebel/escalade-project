...
<div class="container">
    ...
    <c:if test="${ !empty sessionScope.user }">
        ...
        <form:form method="post" action="spot/${publicationId}/sector" class="form-horizontal collapse collapse-menu" modelAttribute="sector">
    ...
    <table class="table table-bordered table-striped table-condensed">
        ...
        <c:forEach var="sector" items="${ sectorList }">
            <tr>
                <td><a href="${pageContext.request.contextPath}/sector/${sector.id}"><c:out value="${ sector.name }" /></a></td>
                <td><c:out value="${ sector.description}" /></td>

                <c:if test="${ !empty sessionScope.user }">
                    <td class="text-center">
                        <c:if test="${ sessionScope.user.role == 'admin' }">
                            <form:form method="post" action="spot/${sector.spotId}/sector/${sector.id}/delete" class="publication-delete${ sector.id }" modelAttribute="sector"/>
                        </c:if>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form:form method="post" action="spot/${sector.spotId}/sector/${sector.id}/update" class="form-horizontal publication-update" modelAttribute="sector">
                                    <div class="form-group">
